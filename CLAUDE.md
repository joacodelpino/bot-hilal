...
- ¿El endpoint `/api/orders/incoming` del CRM sigue vigente tal cual está en `PLAN_INTEGRACION_WHATSAPP_ORDERS_V2.md`, o cambió desde que ese doc se escribió (dado que ya sabemos que ese doc tiene al menos un dato desactualizado, SQLite vs Postgres)?
...
- Si "Aji" (id 46) y "Aji huchukita" (id 45) son productos distintos o hay una duplicación a resolver.
